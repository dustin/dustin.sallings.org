...
understand data I'm collecting in Couchbase Server (the incremental
Map Reduce Views are identical to Apache CouchDB views, so everything
will also work with CouchDB) because I find it quite interesting,
useful and easy.  However, it's been difficult for me to figure out a
good starting point because I don't know who the audience would be.
That is, finding the right set of assumptions to get going has been
quite hard.
